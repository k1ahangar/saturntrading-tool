...
const INTERVAL = "1m"; // Adjusted for 1-hour trading
...
async function fetchHistoricalData(symbol) {
    try {
        ...
        console.error(`Error fetching historical data for ${symbol} (1H approximation):`, error);
        return [];
    }
}
...
}, 10000); // Faster updates for high-frequency trading
